...
class PrintFormatController:
    ...
    @route.get("/print-formats", response=List[PrintFormatSchema], auth=JwtOrInboundKey())
    def list_print_formats(self, request):
        return PrintFormatService.get_list_template(request)

    @route.post("", response=PrintFormatSchema, auth=JwtOrInboundKey())
    ...
    @route.get("/{print_format_id}", response=PrintFormatSchema, auth=JwtOrInboundKey())
    ...
    @route.put("/{print_format_id}", response=PrintFormatSchema, auth=JwtOrInboundKey())
    ...
    @route.delete("/{print_format_id}", auth=JwtOrInboundKey())
    ...
    @route.get("/print-formats/fields/model", response=List[ModelFieldSchema], auth=JwtOrInboundKey())
    ...
    @route.get("/print-formats/{print_format_id}/preview", response=PrintFormatPreviewSchema, auth=JwtOrInboundKey())
    ...
    @route.post("/print-formats/{print_format_id}/print", auth=JwtOrInboundKey())
