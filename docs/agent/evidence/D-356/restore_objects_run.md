...
| **해시 일치** | **3개** |
| 어긋난 것 | 0개 |
| 복구 버킷 | `gx-restore-20260829160705` (예행 뒤 지웠다) |
...
mc mb gx-restore-20260829160705
mc cp --recursive /docs/agent/evidence/D-356/backup/objects/ gx-restore-20260829160705/
mc rb --force gx-restore-20260829160705
```
