# OPS-12 — 백업을 다른 볼륨에 두고, 거기서 읽었다 (2026-09-07 19:11:57)
...
docker run --rm --network gx-main-network -v gx_backup_vault_e:/backup \
    ...
    pg_dump -h postgres -p 5432 -U postgres -d database_guardianx -Fc -f /backup/database_guardianx_20260907T191153.dump
rc=0
```
...
-rw-r--r-- 1 root root 40242094 Sep  7 10:11 /backup/database_guardianx_20260907T191153.dump
9e35e04b9c21a998bcf6edaf4ec4513c7baa227a79a1b23988bfba1882e6db93  /backup/database_guardianx_20260907T191153.dump   # sha256sum 출력 — 내용 해시이지 자격증명이 아니다
3351
rc=0
```
...
이번 덤프(`database_guardianx_20260907T191153.dump`)가 저장소 작업복사본 안에 있는가: **없다**
...
파일 이름 `database_guardianx_20260907T191153.dump` · sha256 `9e35e04b9c21a998bcf6edaf4ec4513c7baa227a79a1b23988bfba1882e6db93`
판정 **통과**
