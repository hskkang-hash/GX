# OPS-12 — 백업을 다른 볼륨에 두고, 거기서 읽었다 (2026-09-05 13:06:20)
...
docker run --rm --network gx-main-network -v gx_backup_vault_e:/vault \
    ...
    pg_dump -h postgres -p 5432 -U postgres -d database_guardianx -Fc -f /vault/database_guardianx_20260905T130618.dump
rc=0
```
...
-rw-r--r-- 1 root root 4511332 Sep  5 04:06 /vault/database_guardianx_20260905T130618.dump
53b20e3332e0c0cd3c385d30d97eb16856474a3fd9b6aa13305c6a90ca75672d  /vault/database_guardianx_20260905T130618.dump   # sha256sum 출력 — 내용 해시이지 자격증명이 아니다
3337
rc=0
```
...
이번 덤프(`database_guardianx_20260905T130618.dump`)가 저장소 작업복사본 안에 있는가: **없다**
...
파일 이름 `database_guardianx_20260905T130618.dump` · sha256 `53b20e3332e0c0cd3c385d30d97eb16856474a3fd9b6aa13305c6a90ca75672d`
판정 **통과**
