# OPS-07 — 로그 수집기를 전수로 쟀다 (2026-09-05 15:38:12)
...
| DB 감사 로그 · logger_auditlogs | 90일 (beat ops-audit-purge-daily · 워커 1) | 4행 | 96행 | 행 1427개 · 3571712바이트 · 가장 오래된 2026-08-27 13:28:44.947815+00:00 · 워커 gxprobe-e@775d49d45445 |
...
## 2. 판정
  ...
  FAIL ② 보존 기간        **보존 기간이 없다**(무한 적재): 컨테이너 stdout · gx-shell, 컨테이너 stdout · postgres, 컨테이너 stdout · redis, 컨테이너 stdout · guardianx-source-minio-1, 컨테이너 stdout · gx-fe-build, 파일 · gx-nginx-e:/var/log/nginx/gx-front.access.log
