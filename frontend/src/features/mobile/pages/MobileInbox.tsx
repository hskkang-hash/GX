      ...
      banner={
        ...
        >
          ...
          <Alert
            type="warning"
            showIcon
            message="범위: 우리 관제에 나간 발송 전부 (아직 「나에게 온 것」이 아닙니다)"
            description={
              <Text style={{ fontSize: 12 }}>
                서버가 테넌트까지는 걸러 줍니다. 수신자까지 좁히는 인자(`mine`)가
                `GET /api/dsm/deliveries` 에 아직 없습니다 [실측 2026-09-04]. 화면이
                받아서 스스로 거르면 페이지 밖 발송이 없는 것이 되므로, 거르지 않고
                이 사실을 적습니다.
              </Text>
            }
          />
