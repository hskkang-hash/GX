import {
  OrderStatusPageAction,
  OrderStatusPageState,
} from '../types/orderStatus.types';

export const initialOrderStatusState: OrderStatusPageState = {
  pageSize: null,
  currentPage: 1,
  selectedRows: [],
  selectedRow: null,
...
export function OrderStatusPageReducer(
  state: OrderStatusPageState,
  action: OrderStatusPageAction,
): OrderStatusPageState {
  switch (action.type) {
    case 'SET_PAGE_SIZE':
