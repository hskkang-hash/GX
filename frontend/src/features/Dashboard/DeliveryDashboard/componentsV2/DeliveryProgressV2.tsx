...
import { border, cardBg, colorOpacity, textLabel } from '@/configs/Colors';
...
const DeliveryProgressV2: React.FC<Props> = ({ panel }) => {
  const { t } = useTranslation();
  const [theme] = useTheme();
  const [menuData] = useMenuData();
    ...
    >
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'row' }}>
          {/* Pie Chart */}
          <div
            style={{ position: 'relative', width: '60%', padding: '0.25rem' }}
          >
            <ResponsiveContainer
              width="100%"
              height="100%"
          ...
          {data.map((item, index) => (
            <div
              ...
              style={{
                ...
                justifyContent: index === 2 ? 'space-between' : 'center',
...
export default DeliveryProgressV2;
