...
const CHAPTERS: Chapter[] = [
  {
    ...
    steps: [
      ...
      '아무 일 없을 때는 카메라 화면에서 격자로 봅니다. 검은 칸은 카메라 무응답입니다.',
      '교대 끝에는 인계 메모에 미처리 이벤트와 특이사항을 적고 로그아웃합니다.',
  ...
  },
  {
    ...
    steps: [
      ...
      '「미처리」에서 남은 것을 봅니다. 재판정할 때는 사유가 필요합니다.',
      '「내 담당」에서 누가 무엇을 했는지 봅니다.',
  ...
  },
  {
    ...
    steps: [
      ...
      '시스템 화면에서 카메라 무응답과 저장 용량 임계를 봅니다. 아침마다 오던 정상 알림이 안 오면 장애입니다.',
