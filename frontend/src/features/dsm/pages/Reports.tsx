    ...
    <Space direction="vertical" size="middle" style={{ width: '100%' }}>
      ...
      <Card size="small" title="실행 기록" extra={<Button onClick={runs.reload}>새로고침</Button>}>
        <StateBoundary
          ...
          where="Reports/실행 목록"
          /*
           * ★ [P-185 ㉣ · 턴 W] **0건을 실제로 만들어 놓고 고친 문구다.**
           *   종전: 「아직 만든 보고서가 없습니다. (요청은 성공했고 0건입니다)」
           *   그 괄호는 바로 아래 줄이 이미 적는 말이었다(`emptySpeech.why`) — 같은
           *   문장이 한 상자에 두 번 있었고, 괄호 안은 사람의 말이 아니라 **응답 상태**다.
           *   그리고 사전의 기본 「새 자료가 생기면 이 자리에 나타납니다」는 이 자리에서
           *   **거짓말**이다 — 보고서는 기다린다고 생기지 않는다. 사람이 누르거나
           *   매월 1일 배치가 낸다. 그 둘을 이름으로 적는다.
           */
          emptyText="아직 만든 보고서가 없습니다."
          emptyNext="위 서식에서 「만들기」를 누르면 여기에 한 줄이 생깁니다. 매월 1일 자동으로 만들어진 것도 이 자리에 「만든 쪽 · 자동」으로 옵니다."
        >
          <Table<ReportRunRow>
            size="small"
            rowKey="run_id"
