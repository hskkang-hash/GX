...
export const HEADLINE = 'UX-17 훈련 모드 — 켜면 알림이 사람에게 가지 않는다';
 ...
 */
const WIRED_NOTE =
  '켜져 있는 동안 이 테넌트의 알림은 **로그 어댑터로만** 나갑니다 — 소방·팀장에게 ' +
  '문자가 가지 않습니다. 채널 이름은 가장하지 않고 `log` 로 그대로 남으므로, 아래 ' +
  '「실채널 발송」 수가 0이 아니면 그것은 훈련 밖에서 난 발송입니다. 끄는 것을 잊으면 ' +
  '진짜 경보도 사람에게 가지 않습니다.';
              ...
              {!r.measurable ? (
                ...
                <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                  ...
                  <Paragraph type="secondary" style={{ marginBottom: 0 }}>
                    이 보고서의 훈련 창은 감사(`guardianx.dsm.drill`)에서 왔습니다.
                    이벤트에 `data_source` 칸을 새로 만들지 않았습니다 — 새 칸은 태어나는
                    순간 과거가 비어 있고, 빈 과거는 「전부 실사건이었다」로 읽힙니다.
                  </Paragraph>
                </Space>
              )}
            </Card>
