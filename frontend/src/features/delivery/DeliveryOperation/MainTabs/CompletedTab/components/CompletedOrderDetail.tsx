        ...
        const routesMapData =
          routeDetailData?.route_terminals?.map(
            (
              ...
              if (item.terminal_id === data?.delivery_terminal__id) {
                return {
                  lat: item.latitude,
                  lng: item.longitude,
                  name: item.name,
    ...
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <CustomBreadcrumb
          ...
          buttons={
            data?.mapped_status_code === 'arrived_order'
              ? [
                  <CustomBtn
                    key="complete"
                    label={t('Complete')}
              ...
              : data?.mapped_status_code === 'completed_order'
                ? [
                    <CustomBtn
                      key="download-report"
            ...
            >
              ...
              <FormBlock>
                ...
                >
                  ...
                  >
                    {converRawDateToDateTimeFormat(data?.arrived_time) || '-'}
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    {converRawDateToDateTimeFormat(data?.completed_time) || '-'}
                  </div>
                  <div
                    style={{
                      flex: 2,
