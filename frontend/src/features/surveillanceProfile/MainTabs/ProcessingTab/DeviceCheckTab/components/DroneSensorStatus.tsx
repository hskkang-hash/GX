...
const DroneSensorStatus = ({
	...
	console.log('sensorStatus_detail_device_check', sensorStatus);
	...
	}, [droneSensorColumns, dataLeftTable, dataRightTable, theme]);
					...
					expandIcon={({ isActive }) => (
						<Box display="flex" gap="2rem">
							{isActive ? <IconButton
								...
								onClick={(e) => {
									e.stopPropagation();
									if (onRefreshSensorStatus && !loadingSensorStatus) {
										onRefreshSensorStatus();
									}
								}}
							>
